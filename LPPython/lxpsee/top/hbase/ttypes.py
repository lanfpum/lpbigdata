...
class TGet(object):
    ...
    def __init__(self, row=None, columns=None, timestamp=None, timeRange=None, maxVersions=None, filterString=None,
                 attributes=None, authorizations=None, ):
        self.row = row
...
class TDelete(object):
    ...
    def __init__(self, row=None, columns=None, timestamp=None, deleteType=thrift_spec[4][4], attributes=None,
                 durability=None, ):
        self.row = row
        self.columns = columns
        self.timestamp = timestamp
...
class TScan(object):
    ...
    def __init__(self, startRow=None, stopRow=None, columns=None, caching=None, maxVersions=thrift_spec[5][4],
                 timeRange=None, filterString=None, batchSize=None, attributes=None, authorizations=None,
                 reversed=None, ):
