...
public class WindowSparkStreamJava {
    public static void main(String[] args) throws Exception {
        ...
        JavaPairDStream<String, Integer> stream = pairDStream1.reduceByKeyAndWindow(new Function2<Integer, Integer, Integer>() {
            @Override
            public Integer call(Integer v1, Integer v2) throws Exception {
                return v1 + v2;
            }
        }, new Duration(15 * 1000), new Duration(10 * 1000));
        stream.print();
        jsc.start();
